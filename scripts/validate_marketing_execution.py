...
def main() -> None:
    ...
    phone_haystack = read("src/translations.js") + read("src/pages/Contact.jsx") + read("scripts/generate_seo_html.mjs")
    for phone in ("337 303431", "548-0002", "tel:"):
        assert phone not in phone_haystack, f"phone reference must stay removed: {phone}"
